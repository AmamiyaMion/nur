...
stdenv.mkDerivation {
  ...
  src = fetchzip {
    url = "https://gdlp01.c-wss.com/gds/4/0100012534/01/cnijfilter2-source-6.81-1.tar.gz";
    sha256 = "sha256-HfUos7WY2Gc8X8VgmdGcDhvp2XORIMj+S4ZL8EHhuIo=";
  };
